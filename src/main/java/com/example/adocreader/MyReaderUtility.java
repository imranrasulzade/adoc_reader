...
public class MyReaderUtility {
    ...
    public static String pdfReadByIText(Path pdfFilePath) throws IOException {
        PdfReader reader = new PdfReader("src/main/resources/autogenerateddocument-30685626-3bf7-4cb7-ab7b-7c26582442d3.pdf");
